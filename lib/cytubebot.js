...
Array.prototype.all = function (lambda) { return this.filter(lambda).length == this.length; }
...
CytubeBot.prototype.handleAddMedia = function(data) {
	...
	if (this.playlist.length === 0) {
		...
		var uid = data["after"];
		index = utils.handle(this, "findIndexOfVideoFromUID", uid);
    ...
    if (!this.playlist.slice(0, index).filter(function (elem) { return elem.temp; })) {
